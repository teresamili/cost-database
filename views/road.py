...
from models import RoadFeature, Project, ProjectUnit
from sqlalchemy import and_

road_blueprint = Blueprint('road', __name__)

@road_blueprint.route('/roads', methods=['GET'])
def road_list():
    """
    ...
    # 查询数据库，结合分页
    query = RoadFeature.query.join(ProjectUnit).join(Project).filter(and_(*filters))
