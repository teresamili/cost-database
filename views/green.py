...
from models import GreenFeature, Project, ProjectUnit,Unit
from sqlalchemy import and_

green_blueprint = Blueprint('green', __name__)

@green_blueprint.route('/greens', methods=['GET'])
def green_list():
    """
    ...
    # 查询数据库，结合分页
    query = GreenFeature.query.join(ProjectUnit).join(Project).filter(and_(*filters))
