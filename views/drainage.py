...
from models import DrainageFeature, Project, ProjectUnit
from sqlalchemy import and_

drainage_blueprint = Blueprint('drainage', __name__)

@drainage_blueprint.route('/drainages', methods=['GET'])
def drainage_list():
    """
    ...
    # 查询数据库，结合分页
    query = DrainageFeature.query.join(ProjectUnit).join(Project).filter(and_(*filters))
